        ...
        <div className="col-xl-5 col-lg-6 col-md-7 col-sm-10">
          <div className="mb-5">
            ...
            <p>
              ...
              also has some really nice one liners as well as the older Rider-Waite-Smith descriptions for context.
            </p>
            <p>
              If you're wondering about my favorite physical tarot decks, they're{' '}
              <a href="https://wyrmwoodgaming.com/corrupted-tarot/" target="_blank" rel="noreferrer">
          ...
          <div className="mb-5">
            ...
            <p>
              Images on this site are either my own work or from the Rider-Waite-Smith Tarot Deck (which is in the
              public domain).
            </p>
            <p>
              My images are not for reuse or reposting, though if you want one for any reason, please reach out to me
          ...
          <ul className="list-unstyled d-flex justify-content-center">
            ...
            <li className="m-3">
              <a href="https://cara.app/paperfox" target="_blank" rel="noreferrer">
                <img src="../images/cara-app-logo-circle-White.svg" alt="Cara" />
              </a>
            </li>
            <li className="m-3">
            ...
            <li className="m-3">
              <a href="https://www.linkedin.com/in/nathaliegarfinkle/" target="_blank" rel="noreferrer">
