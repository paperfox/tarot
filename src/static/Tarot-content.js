  ...
  return [
    {
      ...
      altText: 'A sketch of Jason Asano, the main character from He Who Fights With Monsters, about to step off of a cliff while holding a glass of lemonade. Colin, a hivemind swarm of leeches follows along.'
    },
    {
      cardValue: 1,
      artStatus: 'Complete',
    ...
    },
    {
      ...
      reverseCard: 'This is a single step on your journey. It\'s great to recognize your achievement but don\'t let it stop you here. This isn\'t all you have to offer - to yourself or to the world at large. Celebrate, but look next to the future, don\'t spend all your time looking back, even if it is with fondness.',
    ...
    },
    {
      ...
      reverseCard: 'It is arrogant to assume that a position of authority equates to leadership. Arrogantly bossing others around accomplishes nothing other than starting arguments, especially when you lack a vision of where you are headed.',
    ...
    },
    {
      ...
      reverseCard: 'Hope is on the horizon as you recover from a difficult situation or experience. Release negative beliefs and seek out guidance in the process of healing, growth, and transformation. The journey may be difficult but there is a light at the end of the tunnel.',
